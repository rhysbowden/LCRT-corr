...
cac_list = c(2-0.5, 2-0.8, 2-0.95, 1, 0.95, 0.8, 0.5) # cluster auto-correlation, r in Jess' misspecification paper. Values greater than 1 indicate BE model instead of DTD model and will be transformed by 2-value later.
...
if(resuming){ # set these two file names if you are resuming from a previous partially completed run
  summary_fname = '2021-05-23_13-32-57_1.txt'
  if(store_each_replicate){
    details_fname = '2021-05-23_13-32-57_1_details.txt'
  }
  error_fname = '2021-05-23_13-32-57_1_err.txt'
